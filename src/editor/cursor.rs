...
impl CursorState {
    ...
    pub fn move_right(&mut self, line_len_fn: &dyn Fn(usize) -> usize, max_line: usize, select: bool) {
        if !select {
            self.anchor = None;
        } else if self.anchor.is_none() {
            self.anchor = Some(self.primary);
    ...
    pub fn move_down(&mut self, line_len_fn: &dyn Fn(usize) -> usize, max_line: usize, select: bool) {
        if !select {
            self.anchor = None;
        } else if self.anchor.is_none() {
            self.anchor = Some(self.primary);
