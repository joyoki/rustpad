    ...
    ctx.input(|i| {
        ...
        if i.key_pressed(egui::Key::ArrowUp) {
            if app.tab_manager.active().cursor.line > 0 {
                ...
                let max_col = app
                    ...
                    .active()
                    .buffer
                    .line_len(app.tab_manager.active().cursor.line);
                app.tab_manager.active_mut().cursor.col =
                    app.tab_manager.active().cursor.col.min(max_col);
            }
            return;
        }
        ...
        if i.key_pressed(egui::Key::ArrowLeft) {
            if app.tab_manager.active().cursor.col > 0 {
                ...
                app.tab_manager.active_mut().cursor.line -= 1;
                app.tab_manager.active_mut().cursor.col = app
                    .tab_manager
                    .active()
                    .buffer
                    .line_len(app.tab_manager.active().cursor.line);
