...
impl KeyBindings {
    ...
    pub fn notepad_pp() -> Self {
        ...
        bindings.insert(
            Command::NewTab,
            vec![KeyBinding::new(true, false, false, "N")],
        );
        bindings.insert(
            Command::OpenFile,
            vec![KeyBinding::new(true, false, false, "O")],
        );
        bindings.insert(
            Command::Save,
            vec![KeyBinding::new(true, false, false, "S")],
        );
        bindings.insert(
            Command::SaveAs,
            vec![KeyBinding::new(true, true, false, "S")],
        );
        bindings.insert(
            Command::SaveAll,
            vec![KeyBinding::new(true, true, false, "A")],
        );
        bindings.insert(
            Command::CloseTab,
            vec![KeyBinding::new(true, false, false, "W")],
        );
        bindings.insert(
            Command::Undo,
            vec![KeyBinding::new(true, false, false, "Z")],
        );
        bindings.insert(
            Command::Redo,
            vec![KeyBinding::new(true, false, false, "Y")],
        );
        bindings.insert(Command::Cut, vec![KeyBinding::new(true, false, false, "X")]);
        bindings.insert(
            Command::Copy,
            vec![KeyBinding::new(true, false, false, "C")],
        );
        bindings.insert(
            Command::Paste,
            vec![KeyBinding::new(true, false, false, "V")],
        );
        bindings.insert(
            Command::SelectAll,
            vec![KeyBinding::new(true, false, false, "A")],
        );
        bindings.insert(
            Command::Find,
            vec![KeyBinding::new(true, false, false, "F")],
        );
        bindings.insert(
            Command::Replace,
            vec![KeyBinding::new(true, false, false, "H")],
        );
        bindings.insert(
            Command::GotoLine,
            vec![KeyBinding::new(true, false, false, "G")],
        );
        bindings.insert(
            Command::FindInFiles,
            vec![KeyBinding::new(true, true, false, "F")],
        );
        bindings.insert(
            Command::ToggleSidebar,
            vec![KeyBinding::new(true, false, false, "B")],
        );
        bindings.insert(
            Command::ToggleDiffView,
            vec![KeyBinding::new(true, false, false, "D")],
        );
        bindings.insert(
            Command::Palette,
            vec![KeyBinding::new(true, true, false, "P")],
        );
        bindings.insert(
            Command::NextTab,
            vec![KeyBinding::new(true, false, false, "Tab")],
        );
        bindings.insert(
            Command::PrevTab,
            vec![KeyBinding::new(true, true, false, "Tab")],
        );
        bindings.insert(
            Command::Exit,
            vec![
